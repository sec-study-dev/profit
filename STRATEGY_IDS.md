...
| F04 | Maker DSR / sDAI / sUSDS     | DSR-anchored yield, PSM hops, sDAI/sUSDS leveraged via flash mint.            | wave2-F04-agent   | pending  |
| F05 | crvUSD LLAMMA                | Soft-liquidation arbitrage and leveraged crvUSD borrows against LSTs.         | wave2-F05-agent   | pending  |
...
| F07 | Pendle PT / YT               | PT leveraged buy, YT yield speculation, SY composition with LST/LRT/stables. | wave2-F07-agent   | pending  |
| F08 | Ethena USDe / sUSDe          | sUSDe carry, Pendle PT-sUSDe, looped sUSDe on Morpho/Aave.                    | wave2-F08-agent   | pending  |
| F09 | Morpho Blue isolated markets | Custom market loops, flashloan-bootstrap, idle-liquidity capture.             | wave2-F09-agent   | pending  |
...
| F12 | Curve + Convex + bribes      | vlCVX vote-directed bribes, Votium/Hidden-Hand claim loops, gauge ecosystem.  | wave2-F12-agent   | pending  |
...
| F16 | Cross-CDP basis              | (Optional) Multi-CDP loops mixing GHO / crvUSD / DAI / LUSD as base debt.     | wave2-F16-agent   | pending  |
| F17 | Yield-bearing stable carry   | (Optional) USDM / USDY / OUSD / syrupUSDC carry stacks vs sDAI/sUSDS baseline.| wave2-F17-agent   | pending  |
